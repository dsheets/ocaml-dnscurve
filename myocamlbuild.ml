(* OASIS_START *)
(* DO NOT EDIT (digest: 968432cadad1e416128d074f0aea4acb) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("dnscurve", ["lib"]); ("lwt", ["lwt"])];
     lib_c = [];
     flags =
       [
          (["oasis_library_dnscurve_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_dnscurve_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_dnscurve_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_dnscurve_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_dnscurve_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_dnscurve_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_lwt_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_lwt_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_lwt_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_lwt_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_lwt_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_lwt_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])])
       ];
